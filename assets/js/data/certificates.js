const CERTIFICATES_DATA = [
  {
    ...
    "issuer": "Wharton",
    "description": "Participation in a competitive data science program focused on analytical reasoning, collaborative problem solving, and applied quantitative thinking."
  },
  {
    ...
    "description": "Completed advanced enrichment programs exploring astronomy, scientific inquiry, and exposure to real-world research workflows through the Shadow the Scientists initiative."
  },
  {
    ...
    "description": "Awarded second place at a national-level inter-school technology competition focused on innovation, problem solving, and technical presentation."
  },
  {
    ...
    "description": "Selected as a Lodha Genius Programme scholar for advanced enrichment in mathematics and science through mentorship-driven academic exploration."
  },
  {
    ...
    "description": "Qualified for the Tournament of Champions through performance in the World Scholar's Cup global round competitions."
  },
  {
    ...
    "description": "Achieved Rank 2 in the NOF International Mathematics Olympiad, demonstrating strong mathematical problem-solving and analytical reasoning skills."
  },
  {
    ...
    "issuer": "ISTSE",
    "description": "Achieved an international ranking of 110 in the ISTSE examination, demonstrating strong analytical and mathematical reasoning abilities."
  },
  {
    ...
    "description": "Participated in the Harvard Model Congress YGLP program, developing skills in debate, leadership, policy analysis, and collaborative discussion."
  },
  {
    ...
    "description": "Participated in the AMC 10 mathematics competition, engaging with advanced problem-solving and proof-oriented mathematical thinking."
  },
  {
    ...
    "issuer": "ISRO",
    "description": "Completed an online summer course conducted by ISRO exploring foundational concepts in space science, astronomy, and aerospace systems."
  },
  {
    ...
    "image": "",
    "issuer": "World Scholar's Cup",
    "description": "Participated in the regional round of the World Scholar's Cup, engaging in interdisciplinary academic competitions involving debate, writing, and collaborative challenges."
  },
  {
    ...
    "issuer": "World Scholar's Cup",
    "description": "Participated in the 2024 regional round of the World Scholar's Cup, competing across debate, writing, and knowledge-based collaborative events."
  },
  {
    ...
    "issuer": "World Scholar's Cup",
    "description": "Participated in the 2025 regional round of the World Scholar's Cup, focusing on interdisciplinary reasoning and collaborative academic competition."
  },
  {
    ...
    "issuer": "LogiQids",
    "description": "Successfully completed the first round of the LogiQids competition, qualifying for the next stage through logical reasoning and analytical problem solving."
  },
  {
    ...
    "description": "Completed a road safety awareness course focused on responsible public behavior, transportation safety, and community awareness."
  },
  {
    ...
    "description": "Awarded Roll of Honour recognition for consistent academic excellence and strong overall performance."
  },
  {
    ...
    "description": "Recognized for demonstrating IB learner profile attributes through academic engagement, reflection, and collaborative contribution."
  },
  {
    ...
    "issuer": "School Recognition",
    "description": "Awarded Roll of Honour recognition for academic achievement and sustained excellence across subjects."
  },
  {
    ...
    "issuer": "International Baccalaureate",
    "description": "Received recognition for demonstrating IB learner profile values including inquiry, reflection, and principled learning."
  },
  {
    ...
    "issuer": "School Recognition",
    "description": "Recognized for continued academic excellence and strong performance across interdisciplinary coursework."
  },
  {
    ...
    "issuer": "International Baccalaureate",
    "description": "Awarded for embodying IB learner profile characteristics through active participation, inquiry, and reflective learning."
  },
  {
    "id": "sof-imo-round-1",
    ...
    "description": "Participated in the SOF International Mathematics Olympiad Round 1, focusing on mathematical reasoning and competitive problem solving."
  },
  {
    ...
    "issuer": "LIS",
    "description": "Participated in an interschool technology and creativity festival with a focus on stop-motion production and digital storytelling."
  },
  {
    ...
    "description": "Participated in a competitive coding and technology event emphasizing algorithmic thinking and rapid problem solving."
  },
  {
