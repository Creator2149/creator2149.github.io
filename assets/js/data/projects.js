const PROJECTS_DATA = [
...

    {
        ...
        featuredQuote:
            'Good design is invisible when it works — the focus should stay on the initiative, not the interface.',
        ...
        tags: ['Frontend Development', 'Community Initiative', 'Web Design'],
...

    {
        ...
        architectureNotes:
            'The application uses a Supabase backend for authentication and vote persistence while the frontend handles dynamic state updates and live vote aggregation. Validation logic prevents conflicting selections and enforces scheduling constraints.',
        ...
        tags: ['Full Stack Development', 'Supabase', 'Community Tools'],
...

    {
        ...
        longDescription:
            'MealFlow generates personalized meal plans based on family preferences, dietary goals, and available ingredients. The system combines AI-assisted planning with a modern web stack to create practical and adaptive recommendations tailored to Indian cuisine and family structures.',

        architectureNotes:
            'The backend uses FastAPI for API orchestration, Appwrite for backend services and authentication, and Groq-powered AI inference for recommendation generation. Tailwind CSS provides the responsive frontend styling layer.',
        ...
        tags: ['AI Applications', 'Full Stack Development', 'Health Tech'],
...

    {
        ...
        longDescription:
            'Raksha is a self-defense training platform that uses webcam motion tracking and AI-generated feedback to help users practice techniques remotely. The project focuses on accessibility — enabling users to receive structured guidance without requiring physical training infrastructure.',
...

    {
        ...
        longDescription:
            'Socra investigates whether AI systems can encourage deeper reasoning through guided questioning rather than direct answer generation. The project combines qualitative research with prototype conversational systems designed around critical thinking and reflective dialogue.',

        featuredQuote:
            "The goal of intelligence augmentation shouldn't be replacing thought — it should be provoking it.",
        ...
        tags: ['AI Research', 'NLP', 'Critical Thinking'],
...

    {
        ...
        longDescription:
            'The Celestis Conclave is a regional STEM initiative focused on advanced learning, interdisciplinary collaboration, and student-led exploration. I serve as the Mathematics Department Head and part of the core council, contributing to organizational planning and academic direction.',

        tags: ['Leadership', 'STEM', 'Community'],
...

    {
        ...
        longDescription:
            'NOMAD investigates digit classification using neuromorphic computing techniques and spiking neural networks implemented with Nengo. The project compares computational efficiency, biological plausibility, and accuracy against traditional machine learning approaches using the MNIST dataset.',
        ...
        tags: ['Neuromorphic Computing', 'Machine Learning', 'Research'],
...

    {
        ...
        longDescription:
            'Echoes of Etheryn is a multi-book narrative blending cosmic fantasy, science fiction, and philosophical themes. The series explores power, fate, morality, and identity through interconnected storylines and morally complex characters across a shared universe.',

        featuredQuote: "Worldbuilding isn't about inventing places — it's about inventing systems of meaning.",

        tags: ['Creative Writing', 'Fantasy', 'Science Fiction'],
...

    {
        ...
        longDescription:
            'This project models the transmission of diseases using mathematical epidemiology concepts and visualizes infection spread dynamically through a Pygame-based environment. The simulation explores how factors like movement, transmission probability, and recovery rates influence outbreak behavior.',
