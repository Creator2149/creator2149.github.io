...
const PROJECTS = [
  {
    ...
    "longDescription": "Although I was not directly part of the Water Ambassadors initiative, I created the official showcase website featuring cleanliness drives, awareness campaigns, posters, and collaborations with schools and organizations.",
  ...
  },
  {
    ...
    "longDescription": "RawCrypt is planned as an educational platform introducing students to cryptographic systems ranging from Caesar Cipher to RSA using interactive mathematical explanations and modern web technologies.",
    "link": ""
  },
  {
    "id": "raksha",
  ...
  },
  {
    ...
    "longDescription": "This initiative aims to educate elderly individuals about common online scams and cybersecurity threats through relatable real-world analogies and interactive online sessions.",
    "link": ""
  },
  {
    "id": "socra",
    ...
    "longDescription": "Socra is both a business concept and research project investigating how Socratic-style AI systems can encourage critical thinking instead of replacing it through direct answers. The project includes qualitative research and a proof-of-concept implementation.",
    "link": ""
  },
  {
  ...
  },
  {
    ...
    "longDescription": "NOMAD explores digit classification on the MNIST dataset using neuromorphic computing techniques. The project compares spiking neural networks implemented in Nengo against traditional machine learning and deep learning approaches to evaluate efficiency, accuracy, and computational trade-offs.",
    "link": ""
  },
  {
  ...
  },
  {
    ...
    "longDescription": "This project models the transmission of diseases using mathematical epidemiology concepts and visualizes the spread dynamically through a Pygame-based simulation.",
